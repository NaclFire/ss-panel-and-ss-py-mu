...
install_ss_py_mu(){
	...
	install_soft_for_each(){
		...
		if [[ ${release} = "centos" ]]; then
			...
			curl https://raw.githubusercontent.com/NaclFire/ss-panel/master/get-pip.py -o get-pip.py
			python get-pip.py
	...
	git clone https://github.com/NaclFire/shadowsocks-py-mu.git "/root/shadowsocks-py-mu"
	#modify Config.py
